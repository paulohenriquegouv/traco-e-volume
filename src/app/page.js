  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-900 via-primary-800 to-primary-950 text-white">
        {/* Paquímetro: o instrumento diz "precisão" sem precisar escrever a palavra.
            Só a partir de lg — abaixo disso ele brigaria com o texto por espaço.
            O brilho atrás existe por contraste: a peça é preta sobre roxo escuro e
            sem ele o corpo do instrumento desaparece no fundo. */}
        <div aria-hidden className="pointer-events-none hidden lg:block absolute right-0 top-0 h-full w-1/2 select-none">
          ...
          <img
            ...
            alt=""
            className="absolute right-12 xl:right-24 top-1/2 -translate-y-1/2 h-[125%] max-w-none rotate-[24deg] drop-shadow-2xl"
          />
        </div>
